...
void init_pila(){//INICIALIZAR PILA
    Nodo *pila =NULL;
    printf("\nInicializacion realizada correctamente!!\n");
}

void vacia_pila_bool(Nodo *&pila, int n){//VALIDACION SI LA PILA ESTA VACIA
    bool validador;
...
void ins_pila(Nodo *&pila, int n){//INSERTAR VALORES A LA PILA
...
void most_pila(Nodo *&pila, int n){//MOSTRAR LOS VALORES INGRESADOS EN LA PILA
    Nodo *aux=pila;
    n=aux->num;
    pila=aux->Siguiente;
}

void limpiar_pila(Nodo *&pila, int &n){//LIMPIAR PILA
    Nodo *aux=pila;
    n=aux->num;
    pila=aux->Siguiente;
    free(aux);
